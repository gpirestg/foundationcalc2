...
def run():
    ...
    cfg_path = "settings.cfg" #render.com
...
# === SESSION STATE INIT ===
    ...
    if not st.session_state.optimisation_started:
        ...
        #with st.spinner("Optimising..."):
            ...
            #file_path = "/mount/src/foundationcalc2/loads_template/" #streamlit.io
            file_path = "loads_template/" #render.com
            ...
            #optimised_output_path = "/mount/src/foundationcalc2/output/optimised_result.xlsx" #streamlit.io
            optimised_output_path = "output/optimised_result.xlsx" #render.com
